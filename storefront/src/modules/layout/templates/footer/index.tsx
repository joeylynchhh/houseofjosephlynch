      ...
      <div className="content-container flex flex-col w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8">
          ...
          <div className="flex flex-col gap-y-4">
            <h3 className="text-base font-light">Sign up to Our Newsletter</h3>
            <div className="flex flex-col gap-y-4">
              <input
                type="email"
                placeholder="Email"
              ...
              <div className="flex gap-x-4 items-center">
                <label className="flex items-center gap-x-2 cursor-pointer">
                  <input type="checkbox" className="form-checkbox h-4 w-4 text-black border-gray-300" />
              ...
              <button className="w-24 px-4 py-2 border border-gray-300 text-sm font-light hover:bg-black hover:text-white transition-colors">
                Subscribe
              </button>
            </div>
          </div>
